    ...
    <div className='card mt-3 shadow p-3 mb-3 bg-body rounded'>
      <div className='row g-0'>
        ...
        <div className="d-grid col-7 mx-auto">
          <button className='m-1 btn btn-outline-primary' onClick={increaseQuantity}>Add Quantity</button>
          <button className='m-1 btn btn-outline-warning' onClick={decreaseQuantity}>Decrease Quantity</button>
          <button className='m-1 btn btn-outline-danger' onClick={deleteBook}>Delete</button>
        </div>
      </div>
    </div>
  );
